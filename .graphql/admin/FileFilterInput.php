...
class FileFilterInput extends InputObjectType{
                    ...
                    $fields[] = [
                        ...
                        'resolverComposition' => [
                                    ...
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
                                            ...
                                            'description' => 'Find all descendants of \"parentId\" (not only direct children). Caution: Only works with parentId=0 at the moment.
',
                                                            ]; // field
                                return $fields;
            },
