...
class FileLinkConnection extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'FileLinkConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::FileLinkConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::FileLink()))),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
