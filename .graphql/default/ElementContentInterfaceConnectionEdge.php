...
class ElementContentInterfaceConnectionEdge extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'ElementContentInterfaceConnectionEdge',
...
;
                    $fields[] = [
                        'name' => 'node',
                        'type' => Types::nonNull(Types::ElementContentInterface()),
