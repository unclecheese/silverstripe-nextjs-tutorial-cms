...
class SizedImageConnection extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'SizedImageConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::SizedImageConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::SizedImage()))),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
