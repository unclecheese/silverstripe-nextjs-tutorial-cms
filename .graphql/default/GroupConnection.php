...
class GroupConnection extends ObjectType{
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::GroupConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::Group()))),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
