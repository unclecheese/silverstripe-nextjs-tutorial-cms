...
class SiteConfigConnection extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'SiteConfigConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::SiteConfigConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::SiteConfig()))),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
