...
class ImageInterfaceConnection extends ObjectType{
    public function __construct()
    {
        parent::__construct([
            'name' => 'ImageInterfaceConnection',
                'fields' => function () {
                $fields = [];
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::ImageInterfaceConnectionEdge()))),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::nonNull(Types::ImageInterface()))),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
